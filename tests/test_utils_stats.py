...
@pytest.mark.parametrize('mock_data, mock_thresholds, mock_labels', [
    [(1, 450, 1294, 2455, 3964, 4345), [0, 500, 1000, 1500, 2000, 2500, np.inf], ['0-500', '500-1000', '1000-1500', '1500-2000', '2000-2500', '2500+']],
    [(345, 678), [0, 100, 200, 300, 400, 500, np.inf], ['0-100', '100-200', '200-300', '300-400', '400-500', '500+']],
    [(123, 222, 359, 486), [0, 50, 100, 150, 200, 250, np.inf], ['0-50', '50-100', '100-150', '150-200', '200-250', '250+']],
])
